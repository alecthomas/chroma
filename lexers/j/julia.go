...
var Julia = internal.Register(MustNewLexer(
	...
	Rules{
		"root": {
			...
			{Words(``, `\b`, `function`, `abstract type`, `baremodule`, `begin`, `bitstype`, `break`, `catch`, `ccall`, `continue`, `do`, `else`, `elseif`, `end`, `export`, `finally`, `for`, `if`, `import`, `let`, `macro`, `module`, `mutable`, `primitive`, `quote`, `return`, `struct`, `try`, `using`, `while`), Keyword, nil},
